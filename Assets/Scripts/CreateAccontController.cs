...
public class CreateAccontController : MonoBehaviour
{
    public TMP_Text txtError;
    public TMP_InputField txtUsuario;
    public TMP_InputField txtSenha;
    public TMP_InputField txtConfirmeSenha;
    ...
    void Start()
    {
        ...
        txtConfirmeSenha.contentType = TMP_InputField.ContentType.Password;
    }
    ...
    public void CreateAccount()
    {
        UserCreateRequest userCreateRequest = new UserCreateRequest
        {
            ...
            confirmpassword = txtConfirmeSenha.text
        };
